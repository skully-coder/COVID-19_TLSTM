...
def convert_one_hot(label_list):
    for i in range(len(label_list)):
        ...
        label_list[i] = np.reshape(
            label_list[i], [label_list[i].shape[0], label_list[i].shape[1], 1])
...
def main(training_mode, data_path, learning_rate, training_epochs, dropout_prob, hidden_dim, fc_dim, model_path):
    ...
    if training_mode == 1:
        ...
        training(path, learning_rate, training_epochs, dropout_prob,
                 hidden_dim, fc_dim, training_mode, model_path)
...
if __name__ == "__main__":
    ...
    main(training_mode=1, data_path='BatchData', learning_rate=2e-3, training_epochs=15,
         dropout_prob=0.25, hidden_dim=64, fc_dim=32, model_path='model/')
